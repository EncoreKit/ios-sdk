...
class OfferSheetViewModel: ObservableObject {
    ...
    /// with no app update. Defaults to `.external`.
    ...
    /// Whether a Safari in-app sheet is currently requested (test visibility).
    var _testHasSafariWrapper: Bool { safariWrapper != nil }
    #endif
}
