...
internal final class OfferSheetCoordinator {
    ...
    private static func presentCore(
        ...
        enqueueDiagnostic(.showEntered(placementId: placementId, distinctId: EventEnvelope.resolveDistinctId(), variantId: variantId, presentationId: presentationId))
        ...
        guard #available(iOS 17.0, *) else {
            ...
            enqueueDiagnostic(.showAborted(reason: .unsupportedOS, placementId: placementId, distinctId: EventEnvelope.resolveDistinctId(), variantId: variantId, presentationId: presentationId, iosVersion: version))
        ...
        guard current == nil else {
            ...
            enqueueDiagnostic(.showAborted(reason: .alreadyPresenting, placementId: placementId, distinctId: EventEnvelope.resolveDistinctId(), variantId: variantId, presentationId: presentationId))
        ...
        switch NCLGhostTrigger.evaluate(
            useCase: useCase,
            logExposure: { NCLGhostTrigger.defaultLogExposure($0, variantId: variantId) }
        ) {
        case .suppress:
            ...
            enqueueDiagnostic(.showAborted(reason: .experimentControl, placementId: placementId, distinctId: EventEnvelope.resolveDistinctId(), variantId: variantId, presentationId: presentationId))
    ...
    private func start() {
        guard let analyticsClient = analyticsClient,
            ...
            Self.enqueueDiagnostic(.showAborted(reason: .notConfigured, placementId: placementId, distinctId: EventEnvelope.resolveDistinctId(), variantId: sduiConfigManager?.variantId(for: useCase), presentationId: presentationId))
