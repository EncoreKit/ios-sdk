...
public final class Encore: EncoreProtocol {
    internal static let sdkVersion: String = "1.4.46"
    ...
    public func setUserAttributes(_ attributes: UserAttributes) {
        ...
        // Re-fetch /config when the language attribute changes so the
        // paywall copy + SDUI variant text reflect the new locale on next
        // presentation. No-op when language is unchanged.
