...
struct ShowEnteredEvent: AnalyticsEvent {
    ...
    init(placementId: String?, variantId: String?) {
        self.placementId = placementId
        self.variantId = variantId
    }
}
...
struct ShowAbortedEvent: AnalyticsEvent {
    ...
    init(reason: ShowAbortReason, placementId: String?, variantId: String?) {
...
struct OfferClaimTappedEvent: AnalyticsEvent {
...
struct OfferClaimReturnedEvent: AnalyticsEvent {
...
struct OfferVerifiedEvent: AnalyticsEvent {
    ...
    /// Cross-launch reconciliation: only the transaction id is known.
...
/// simply didn't tap.
struct OfferClaimFailedEvent: AnalyticsEvent {
