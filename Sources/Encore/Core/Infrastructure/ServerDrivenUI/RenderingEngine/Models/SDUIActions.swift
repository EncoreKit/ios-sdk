...
struct SDUIAction: Decodable {
    ...
    private enum CodingKeys: String, CodingKey {
        case type, setState, setValueKey, setValueValue, onSuccessState, onCancelAction
    }

    init(type: SDUIActionType, setState: String? = nil, setValueKey: String? = nil, setValueValue: String? = nil, onSuccessState: String? = nil, onCancelAction: String? = nil) {
        self.type = type
