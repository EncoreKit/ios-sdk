//
//  SDUIVariant_IAPFirst.swift
//  Encore
//
//  IAP-first paywall flow: triggers StoreKit purchase immediately,
//  then shows thank-you screen with partner offers on success.
//
//  Usage: Add `-SDUIDevVariant iapFirst` to Xcode scheme launch arguments.
//

#if DEBUG
enum SDUIVariant_IAPFirst {
    static let json = """
{
    "version": "1.0.0",
