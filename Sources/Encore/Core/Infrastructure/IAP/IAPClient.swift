...
class IAPClient {
    ...
    static func delegatePurchase(productId: String, placementId: String?, promoOfferId: String? = nil, presentationId: String? = nil, useCase: UseCase = .reduceChurn) async -> PublisherOutcome {
        ...
        // variant is the variant of the attempt.
        let variantId = sduiConfigManager?.variantId
        ...
        analyticsClient?.track(IAPNoPurchaseControllerEvent(productId: productId, placementId: placementId, variantId: variantId, presentationId: presentationId, useCase: useCase.rawValue))
        return .notAttempted
    }
