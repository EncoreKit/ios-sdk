...
internal final class StrictUnlockReconciler {
    ...
    func notePending(transactionId: String, recordedAt: Date = Date()) {
    ...
    func reconcile() async {
        ...
        // No sheet context survives to this point; the event carries only the
        // transaction id (never fabricated context fields).
        analyticsClient?.track(OfferVerifiedEvent(transactionId: transactionId))
